...
public class Ed25519FieldElement extends FieldElement {
     ...
     * <p>
     * FIXED HERE: the 19x and 38x scalings below were being evaluated in 32-bit
     * int arithmetic - {@code g[k] * (byte) 0x26} is an int product, widened to
     * long only afterwards. This body is a fiat-crypto translation whose output
     * limbs are wider than ref10's, so a doubled limb (2Z in {@code madd}, say)
     * reaches ~63M, and 38 x 63M overflows int32. The result stayed a plausible
     * field element, which is why nothing threw: {@link GroupElement#scalarMultiply}
     * simply returned the wrong point once a limb crossed 2^31/38, taking SPAKE2
     * and every other consumer with it. Scaling by a long constant fixes it and
     * changes nothing when no overflow would have occurred.
     *
    ...
    public FieldElement multiply(FieldElement val) {
        ...
        int x146;
        int x147;
        x1 = ((long)(t[9]) * ((g[9]) * 0x26L));
        x2 = ((long)(t[9]) * ((g[8]) * 0x13L));
        x3 = ((long)(t[9]) * ((g[7]) * 0x26L));
        x4 = ((long)(t[9]) * ((g[6]) * 0x13L));
        x5 = ((long)(t[9]) * ((g[5]) * 0x26L));
        x6 = ((long)(t[9]) * ((g[4]) * 0x13L));
        x7 = ((long)(t[9]) * ((g[3]) * 0x26L));
        x8 = ((long)(t[9]) * ((g[2]) * 0x13L));
        x9 = ((long)(t[9]) * ((g[1]) * 0x26L));
        x10 = ((long)(t[8]) * ((g[9]) * 0x13L));
        x11 = ((long)(t[8]) * ((g[8]) * 0x13L));
        x12 = ((long)(t[8]) * ((g[7]) * 0x13L));
        x13 = ((long)(t[8]) * ((g[6]) * 0x13L));
        x14 = ((long)(t[8]) * ((g[5]) * 0x13L));
        x15 = ((long)(t[8]) * ((g[4]) * 0x13L));
        x16 = ((long)(t[8]) * ((g[3]) * 0x13L));
        x17 = ((long)(t[8]) * ((g[2]) * 0x13L));
        x18 = ((long)(t[7]) * ((g[9]) * 0x26L));
        x19 = ((long)(t[7]) * ((g[8]) * 0x13L));
        x20 = ((long)(t[7]) * ((g[7]) * 0x26L));
        x21 = ((long)(t[7]) * ((g[6]) * 0x13L));
        x22 = ((long)(t[7]) * ((g[5]) * 0x26L));
        x23 = ((long)(t[7]) * ((g[4]) * 0x13L));
        x24 = ((long)(t[7]) * ((g[3]) * 0x26L));
        x25 = ((long)(t[6]) * ((g[9]) * 0x13L));
        x26 = ((long)(t[6]) * ((g[8]) * 0x13L));
        x27 = ((long)(t[6]) * ((g[7]) * 0x13L));
        x28 = ((long)(t[6]) * ((g[6]) * 0x13L));
        x29 = ((long)(t[6]) * ((g[5]) * 0x13L));
        x30 = ((long)(t[6]) * ((g[4]) * 0x13L));
        x31 = ((long)(t[5]) * ((g[9]) * 0x26L));
        x32 = ((long)(t[5]) * ((g[8]) * 0x13L));
        x33 = ((long)(t[5]) * ((g[7]) * 0x26L));
        x34 = ((long)(t[5]) * ((g[6]) * 0x13L));
        x35 = ((long)(t[5]) * ((g[5]) * 0x26L));
        x36 = ((long)(t[4]) * ((g[9]) * 0x13L));
        x37 = ((long)(t[4]) * ((g[8]) * 0x13L));
        x38 = ((long)(t[4]) * ((g[7]) * 0x13L));
        x39 = ((long)(t[4]) * ((g[6]) * 0x13L));
        x40 = ((long)(t[3]) * ((g[9]) * 0x26L));
        x41 = ((long)(t[3]) * ((g[8]) * 0x13L));
        x42 = ((long)(t[3]) * ((g[7]) * 0x26L));
        x43 = ((long)(t[2]) * ((g[9]) * 0x13L));
        x44 = ((long)(t[2]) * ((g[8]) * 0x13L));
        x45 = ((long)(t[1]) * ((g[9]) * 0x26L));
        x46 = ((long)(t[9]) * (g[0]));
        x47 = ((long)(t[8]) * (g[1]));
        x48 = ((long)(t[8]) * (g[0]));
        x49 = ((long)(t[7]) * (g[2]));
    ...
    public FieldElement square() {
        ...
        int f6_2 = 2 * f6;
        int f7_2 = 2 * f7;
        long f5_38 = 38L * f5; /* 1.959375*2^30 */
        long f6_19 = 19L * f6; /* 1.959375*2^30 */
        long f7_38 = 38L * f7; /* 1.959375*2^30 */
        long f8_19 = 19L * f8; /* 1.959375*2^30 */
